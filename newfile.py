...
def samadengan():
    ...
    if mtk == "penjumlahan":
        ...
        try:
            ...
            e.insert(0,"maaf nomor yang anda masukan tidal valid")
...
tam = Button(root,text="+",padx = 33,bg="#878787",fg="white", pady = 20,command=tambah)
kur = Button(root,text="-",padx = 35,bg="#878787",fg="white", pady = 20,command=kurang)
bag  = Button(root,text=":",padx = 35,bg="#878787",fg="white", pady = 20,command=bagi)
kal = Button(root,text="x",padx = 35,bg="#878787",fg="white", pady = 20,command=kali)
pang = Button(root,text="x2",padx = 25,bg="#878787",fg="white", pady = 20,command=pangkat)
ak2 = Button(root,text="akr",padx = 25,bg="#878787",fg="white", pady = 20,command=akar)
